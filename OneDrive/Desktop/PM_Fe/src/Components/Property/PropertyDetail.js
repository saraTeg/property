...
import { Edit, MapPin, Home, Calendar, DollarSign } from 'lucide-react';
import Modal from '../../UI/Modal';
import Button from '../../UI/Button';
import Badge from '../../UI/Badge';

const PropertyDetail = ({ 
  property,isOpen,onClose,onEdit }) => {
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button onClick={onEdit} icon={<Edit size={16} />}>Edit Property</Button>
        </>
      }
    >
